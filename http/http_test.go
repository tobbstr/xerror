...
func TestError(t *testing.T) {
	...
	/* ---------------------------------- When ---------------------------------- */
	err := NewInternalError(context.Background()).WithError(errors.New("original error")).WithRetry().
		WithSeverity(xerror.SeverityError).WithVars(vars...)

	/* ---------------------------------- Then ---------------------------------- */
	require.Equal(t, err.Err, errors.New("original error"))
	require.Equal(t, err.Retryable, true)
	require.Equal(t, err.Severity, xerror.SeverityError)
